...
To use vano for worm visualization, open `wano.exe`, `Press No` for stack image as rows, 
and than drag the `nhr-206_XIL0604_20140708_0001_S1.ano` or `nhr-206_XIL0604_20140708_0001_S1_recog.ano` file to vano interface.

`traindata` folder contain all data for atlas generation, RAPCAT training and atlas for RAPCAT annotation.
