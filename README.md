...
After cell annotation is finished, you can visulize the image stack and annotation result using software VANO  in `vano_win32_1.741` folder. At first, open the VANO by promting wano.exe. Next, choose layout of stacking as two rows by pressing  'No' button. Then
drag the `nhr-206_XIL0604_20140708_0001_S1.ano` or `nhr-206_XIL0604_20140708_0001_S1_recog.ano` file to VANO interface.

The `traindata` folder contains all data for atlas generation, RAPCAT training and atlas for RAPCAT annotation.
